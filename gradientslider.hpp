...
public:
  ...
  GradientSliderHandle *alt_handle;
...
public:
  /** Constructor */
  SliderEventFilter(GradientSlider *_grandParent)
...
private:
  /** Store the GradientSlider that this event filter is used within. */
  GradientSlider *grandParent;
};

class GradientSliderHandle: public QLabel
{
  Q_OBJECT
public:
  /** Constructor */
  GradientSliderHandle(GradientSlider *parent = 0);
