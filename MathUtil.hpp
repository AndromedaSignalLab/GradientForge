...
public:
    ...
    static QPoint getPositionForNormalizedValue(qreal normalizedValue, QRect contentsRect, qreal boundarySpace, qreal sliderHandleWidth, Qt::Orientation orientation);
};
